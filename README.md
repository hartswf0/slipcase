...
<p align="center">
  ...
  <em>A self-contained, mobile-first research console, zettel lines inspector, slipcard flipper, PDF reader, and prompt operator across 43 field slipcases.</em>
</p>
...
1. **[LINES] Zettel Lines Inspector**: Complete atomic breakdown of all **1,598 zettel cards** into structured, selectable field rows (`QUESTION`, `DEEPER QUESTION`, `PASSAGE`, `RESEARCH OBJECT`, `LOCAL MOVE`, `MECHANISM`, `FORMAL SHIFT`, `BIBTEX`, etc.) with multi-line selection, continuous reading stack, and clipboard export.
...
**HEAD layer:** 43 canonical HEAD ZETTELs, one per field, mapped to all 132 PDFs in `heads-pdf-map.html` / `.json` / `.txt`.
---
...
| Stack Reader    | Touch Swipe      | Direct Open     | 43 Workspaces   |
+-----------------+------------------+-----------------+-----------------+
```
...
- **Workspace Navigation**: Switch between all 43 slipcases or browse global decks.
...
| 18 | `2026-09-21__prompt-does-not-contain-its-own-force__SLIPCASE-PROMPT-LANGUAGE-GAME-20260921` | 23 | 2 | 10 |
| 19 | `2026-09-22__the-prompt-is-not-a-genre__PROMPT-GAMES-WORLDTEXT` | 23 | 1 | 8 |
| 20 | `FINAL_SLIPCASE__Mastery_Without_Sovereignty__ALL_ZETTELS__2026-08-18` | 39 | 4 | 12 |
| 21 | `HOUSE_LANGUAGE_SUBURB_SLIPCASE_2026-08-18` | 48 | 2 | 10 |
| 22 | `SLIPCASE_13.1__2026-08-17__the-unlived-curriculum` | 24 | 6 | 11 |
| 23 | `SLIPCASE_AFTER_SURPRISE_FINAL_2026-08-18` | 157 | 4 | 10 |
| 24 | `SLIPCASE_DEEP_LINEAGE_2026-08-18` | 121 | 13 | 10 |
| 25 | `SLIPCASE__PROMOTION_FIELD__2026-08-18__74d74484bfdd` | 30 | 1 | 10 |
| 26 | `SLIPCASE__theory-lag__20260818T030003-0400` | 32 | 2 | 14 |
| 27 | `THE_HUT__FINAL_FIELD__2026-08-18` | 2 | 1 | 1 |
| 28 | `YELMO_FINAL__all-zettels-and-paper` | 25 | 3 | 10 |
| 29 | `black-mountain-structured-openness__SCF-20260818-BMC-004__v15.55-AM__FINAL` | 28 | 3 | 10 |
| 30 | `house-language__FULL-FINAL__2026-08-18` | 39 | 4 | 12 |
| 31 | `house_language_many_mansions_2026-08-18` | 62 | 1 | 10 |
| 32 | `how_is_this_gonna_be_screwed_up_20260817` | 6 | 1 | 0 |
| 33 | `primitive_construction_slipcase_20260818` | 16 | 1 | 10 |
| 34 | `prompt-forward-slipcase-2026-08-18` | 95 | 1 | 10 |
| 35 | `prompt-magic-generative-trajectory__2026-08-18` | 27 | 1 | 10 |
| 36 | `prompt-practices__FINAL__2026-08-18` | 32 | 3 | 12 |
| 37 | `safe-relational-freedom-field__2026-08-18__a5ef0e2e` | 50 | 8 | 11 |
| 38 | `slipcase-intro__2026-08-18__082152Z` | 25 | 1 | 10 |
| 39 | `slipcase_final_20260818` | 46 | 8 | 11 |
| 40 | `slipcase_noise_of_sculptors_2026-08-17_2254` | 38 | 20 | 11 |
| 41 | `slipcase_ontology_build` | 1 | 4 | 0 |
| 42 | `the-casino-in-the-fountain__slipcase-v15.55-AM__156066d527d3__2026-08-17T203217-0400` | 38 | 2 | 10 |
| 43 | `the-prompt-keeps-disappearing__FINAL-SLIPCASE-15.55-AM__2026-08-18` | 43 | 4 | 12 |
| **Total** | **43 Field Slipcases** | **1,598 Slips** | **132 PDFs** | **391 Docs** |
